    ...
    <SafeAreaView style={backgroundStyle}>
      ...
      <ScrollView
        ...
        <View
          ...
          <Section title="Enable Fullstory">
            <Switch
              value={fullstoryEnabled}
              onValueChange={setFullstoryEnabled}
            />
          </Section>
          {[...Array(50).keys()].map(key => renderContent(key))}
        </View>
      </ScrollView>
    </SafeAreaView>
  );
